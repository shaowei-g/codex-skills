...
Everything else should live in one canonical reference or the owning specialist skill. Specialists should load only a thin execution contract, shared status semantics, and the shared response schema, not orchestration mechanics.
