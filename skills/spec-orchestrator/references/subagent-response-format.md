...
- spec-analyst | spec-planner | spec-tasker | spec-implementer | spec-verifier | spec-drift-check | spec-handoff | none
...
- `Assigned-Subagent` is required and must name the assigned subagent only.
...
- `Recommended-Next-Subagent` contains at most one advisory next subagent recommendation for the orchestrator.
